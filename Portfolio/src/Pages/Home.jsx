            ...
            <div >
                <div className="min-h-[43vh] md:min-h-[55vh] mx-auto bg-white flex items-center md:items-center justify-center ">
                    <div className='max-w-[50%]'>
                        ...
                        <Link to={'/Pages/Contact'} ><button class="px-5 py-2.5 relative rounded group font-medium text-white inline-block">
                            ...
                            <span class="relative flex items-center justify-center">Reach Me Out</span>
                        </button></Link>
                    </div>
                    <div >
