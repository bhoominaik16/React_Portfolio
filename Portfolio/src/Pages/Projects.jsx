            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-10 md:gap-5 place-items-center items-stretch">
                <div className="max-w-sm bg-white border border-gray-200 rounded-lg shadow-sm dark:bg-gray-800 dark:border-gray-700">
                    ...
                    <div className="p-5">
                        ...
                        <a href="https://github.com/bhoominaik16/BiteCircle---Cooking-Community" className="px-5 py-2.5 relative rounded group font-medium text-white inline-block"  target="_blank">
                            ...
                            <span className="relative flex items-center justify-center">Visit Project
