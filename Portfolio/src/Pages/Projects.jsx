        ...
        <section className="min-h-[90vh] p-[5vh] text-center">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-10 md:gap-5 place-items-center">
                <div className="h-[30vh] w-[30vw] md:w-[14vw] border border-violet-300 rounded-lg">
                    <h1 className="h-[25vh] md:h-[20vh] p-4 flex items-center justify-center font-semibold">Weather App using React and chart.js</h1>
                ...
                <div className="h-[30vh] w-[30vw] md:w-[14vw] border border-violet-300 rounded-lg">
                    <h1 className="h-[25vh] md:h-[20vh]  p-4 flex items-center justify-center font-semibold">Recipe Book using React</h1>
                ...
                <div className="h-[30vh] w-[30vw] md:w-[14vw] border border-violet-300 rounded-lg">
                    <h1 className="h-[25vh] md:h-[20vh] p-4 flex items-center justify-center font-semibold ">A simple functional calculator built using React and Tailwind CSS</h1>
                ...
                <div className="h-[30vh] w-[30vw] md:w-[14vw] border border-violet-300 rounded-lg">
                    <h1 className="h-[25vh] md:h-[20vh]  p-4 flex items-center justify-center font-semibold">A BootStrap based website 'PetConnect' built to help Pet Animals</h1>
