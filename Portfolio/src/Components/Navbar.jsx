...
function Navbar(){
    ...
    return(
        <header >
            <nav >
                <div className='max-h-[10vh] p-5 bg-violet-200 flex items-center md:justify-between'>
                    ...
                    <div className={`
                        ${showmenu ? 'flex ' : 'hidden'} absolute top-[10vh] left-0 bg-violet-200 min-h-[40vh] w-full md:w-auto md:static md:min-h-full md:flex  `}>
                        <ul className='flex flex-col gap-[5vh] my-auto md:items-center justify-center md:flex-row md:gap-[4vw] font-semibold text-2xl mx-10'>
