        ...
        <header >
            <nav >
                <div className='relative max-h-[10vh] p-5 bg-gradient-to-br text-white from-blue-400 to-purple-600 flex items-center md:justify-between z-50'>
                    ...
                    <div className={`
                        ${showmenu ? 'flex bg-gradient-to-br from-blue-400 to-purple-600' : 'hidden'}  absolute top-[10vh] left-0  min-h-[40vh] w-full md:w-auto md:static md:min-h-full md:flex  `}>
